        ...
        private String SubmitMessage(string id)
        {
            return $@"
                <div style='font-size:14px; font-family:Arial, sans-serif; color:#434343; line-height:1.5;'>
                    ...
                    <p><a href='https://twillink-main-service-158474999909.asia-southeast2.run.app/api/v1/auth/aktifasi/{id}' style='color:#1a73e8; text-decoration:none;'>Activate Your Account</a></p>
